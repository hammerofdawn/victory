...
urlpatterns = [
	...
	url(r'^users/(?P<user_pk>[0-9]+)/settings/description$', views.userdescription, name='userdescription'),
 	url(r'^users/(?P<user_pk>[0-9]+)/settings/image$', views.userimage, name='userimage'),
